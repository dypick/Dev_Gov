...
import java.util.logging.Logger;
    ...
    public class GeoJsonActivity extends Activity {
        ...
        private final Point CAMERA_TARGET = new Point(52.971381, 36.063083);

        private Logger LOGGER = Logger.getLogger("devgovappeal.geojson");
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.geo_json_layout);
